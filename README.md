...
9. Turn the model on and wait ~10 seconds for WiFi connection.
10. Once you see the device on the network (its hostname will start with `mpy-` and end with `esp32c3`), you can access it over HTTP at its IP address on port 5000.
11. Use the provided web page to control the train speeds.
